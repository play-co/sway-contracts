/*
    Description: Central Collection for a large number of SwayMoment
                 NFTs

    This resource object looks and acts exactly like a SwayMoment MomentCollection
    ...
    However! The main SwayMoment administration account DOES need to worry about it
...
pub contract SwayMomentShardedCollection {

    // Named Paths
    pub let ShardedMomentCollectionPath: StoragePath

    // ShardedCollection stores a dictionary of SwayMoment Collections
    // A Moment is stored in the field that corresponds to its id % numBuckets
    pub resource ShardedCollection: SwayMoment.MomentCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic {

        // Dictionary of SwayMoment collections
        pub var collections: @{UInt64: SwayMoment.Collection}
        ...
        init(numBuckets: UInt64) {
            ...
            while i < numBuckets {
                ...
                self.collections[i] <-! SwayMoment.createEmptyCollection() as! @SwayMoment.Collection
        ...
        pub fun batchWithdraw(ids: [UInt64]): @NonFungibleToken.Collection {
            var batchCollection <- SwayMoment.createEmptyCollection()
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            ...
            let collectionRef = &self.collections[bucket] as! &SwayMoment.Collection
    ...
    init() {
        // Set our named paths
        self.ShardedMomentCollectionPath = /storage/ShardedMomentCollection
    }
}
